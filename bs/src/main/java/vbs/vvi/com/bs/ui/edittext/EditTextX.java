package vbs.vvi.com.bs.ui.edittext;
...
public class EditTextX extends EditText implements OnTouchListener, TextWatcher, OnFocusChangeListener {
	...
	private void init() {
		...
		if (mRightDrawable == null) {
			mRightDrawable = mContext.getResources().getDrawable(R.drawable.selector_edit_text_with_del);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if (event.getX() > et.getWidth() - et.getPaddingRight() - mRightDrawable.getIntrinsicWidth() - 10) {
			et.setText("");
			EditTextX.this.removeClearButton();
		}
		return false;
	}
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		...
		EditTextX.this.manageClearButton();
		if (listener != null) {
