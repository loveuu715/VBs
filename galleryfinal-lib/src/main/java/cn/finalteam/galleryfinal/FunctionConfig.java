...
public class FunctionConfig implements Cloneable{
    ...
    private boolean closeSelectAfter ;//编辑时是否关闭选择界面
    ...
    private FunctionConfig(final Builder builder) {
        ...
        this.closeSelectAfter = builder.closeSelectAfter;
    }
    ...
    public static class Builder {
        ...
        private boolean forceCropEdit;//强制裁剪后是否可对图片编辑，默认不可以
        private boolean preview;//预览
        private boolean closeSelectAfter = false;
...
//                this.selectedList = list;
        ...
        /**编辑图像时是否关闭选择界面*/
        public Builder setCloseSelectAfter(boolean closeSelectAfter){
            this.closeSelectAfter = closeSelectAfter;
            return this;
        }
    ...
    public boolean isCloseSelectAfter() {
        return closeSelectAfter;
    }
